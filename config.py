...
parser.add_argument('--SEED_DATA', required=False, default = 0)
...
parser.add_argument('--SUBNODE', required=False, default=2)

parser.add_argument('--ITERATIONS', required=False, default=10000)
parser.add_argument('--LOSS_PRINT', required=False, default=1000)
