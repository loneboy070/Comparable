...
parser.add_argument('--N_ITEM', required=False, default = 10)
parser.add_argument('--SEED_DATA', required=False, default = 1)


parser.add_argument('--Node_Sizes', required=False, default=[5, 10, 10, 1])
parser.add_argument('--STEPS', required=False, default=10000000)
parser.add_argument('--LOSS_PRINT', required=False, default=30000)
