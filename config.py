...
parser.add_argument('--N_TEST', required=False, type=int, default=100, help='fuck')
...
parser.add_argument('--ITERATIONS', required=False, type=int, default=120000)
parser.add_argument('--START_ITER', required=False, type=int, default=0)
parser.add_argument('--END_ITER', required=False, type=int, default=0)


parser.add_argument('--LOSS_PRINT', required=False, type=int, default=1)
parser.add_argument('--TEST_LOSS_PRINT', required=False, type=int, default=True)
parser.add_argument('--TEST_BATCH', required=False, type=int, default=300)
...
parser.add_argument('--DROPOUT', required=False, type=float, default=0)
